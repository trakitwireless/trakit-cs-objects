...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class ReqMaintenanceScheduleList : Request, IReqIDeletable {
		/// <summary>
	...
	/// </summary>
	public class ReqMaintenanceScheduleListByCompany : ReqMaintenanceScheduleList, IReqListByCompany {
		/// <summary>
