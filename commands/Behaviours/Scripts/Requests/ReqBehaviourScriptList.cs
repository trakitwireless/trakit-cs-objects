...
namespace Trakit.Commands {
	...
	/// </summary>
	public abstract class ReqBehaviourScriptList : Request, IReqIDeletable {
		/// <summary>
	...
	/// </summary>
	public class ReqBehaviourScriptListByCompany : ReqBehaviourScriptList, IReqListByCompany {
		/// <summary>
