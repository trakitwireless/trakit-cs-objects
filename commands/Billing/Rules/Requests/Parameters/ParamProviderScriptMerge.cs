...
namespace Trakit.Commands {
	/// <summary>
	/// Parameters used to create or update an <see cref="BillableHostingRule"/>.
	/// </summary>
	public class ParamBillableHostingRuleMerge : ParamMergeSubscribable {
		/// <summary>
		/// The unique identifier of the <see cref="BillableHostingRule"/> you want to update.
		/// Leave this as <c>null</c> when creating a new <see cref="BillableHostingRule"/>.
		/// </summary>
		public ulong? id;
		/// <summary>
		/// The <see cref="Company"/> to which this <see cref="BillableHostingRule"/> belongs.
		/// After creation, this value is read-only.
		/// </summary>
		public ulong? company;
		/// <summary>
		/// Name for the <see cref="BillableHostingRule"/>.
		/// </summary>
		public string name;
		/// <summary>
		/// Notes for the <see cref="BillableHostingRule"/>.
		/// </summary>
		public string notes;
		/// <summary>
		...
		/// <summary>
		/// <see cref="Picture"/>s of this <see cref="BillableHostingRule"/>.
		/// </summary>
